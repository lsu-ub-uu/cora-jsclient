...
QUnit.module("login/loginManagerFactoryTest.js", {
	beforeEach : function() {
		this.dependencies = {
			...
			passwordLoginJsClientIntegratorFactory : {
				type : "fakePasswordLoginJsClientIntegratorFactory"
			},
			authTokenHolder : {
...
QUnit.test("factor",
		function(assert) {
			...
			let loginManager = this.loginManagerFactory.factor(loginManagerSpec);
			assert.strictEqual(loginManager.type, "loginManager");

			let loginManagerDependencies = loginManager.getDependencies();
			...
			assert.strictEqual(loginManagerDependencies.passwordLoginJsClientIntegratorFactory.type,
					"fakePasswordLoginJsClientIntegratorFactory");
			...
			loginManagerSpec = loginManager.getSpec();
