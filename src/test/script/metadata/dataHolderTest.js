...
QUnit.module("presentation/dataHolderTest.js", hooks => {
    ...
    const newDataHolder = function(metadataId) {
        let spec = {
    ...
    test("testInit", function(assert) {
        let dataHolder = CORA.dataHolder(spec);
        assert.strictEqual(dataHolder.type, "dataHolder");
    });

    test("testGetSpec", function(assert) {
        let dataHolder = CORA.dataHolder(spec);
        assert.strictEqual(dataHolder.getSpec(), spec);
    });

    test("testInit2", function(assert) {
        let dataHolder = newDataHolder("recordTypeOnlyMetadataIdChild");
    ...
    test("testFindContainerTopLevelPath", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        let path = [];
    ...
    test("testFindContainerTwoChildrenWithSameMetadataIdDifferentRepeatId", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        let path = [];
    ...
    test("testFindContainerTwoChildrenWithDifferentMetadataIdDifferentRepeatId", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        let path = [];
        dataHolder.addChild(path, "textVariableId", "one");
    ...
    test("testFindContainerDeeperChild", function(assert) {
    ...
    test("testFindContainerDeeperChildRepeatId", function(assert) {
        let path = ["groupIdOneTextChild"];
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testFindContainerNotFound", function(assert) {
        let path = ["groupIdOneTextChild"];
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testCreateNewDataHolder", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testCreateGroupIdOneTextChildOneAttribute", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChildOneAttribute");
    ...
    test("testCreateGroupIdOneTextChildTwoAttributes", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChildTwoAttributes");
    ...
    test("testAddChildToGroupIdOneTextChild", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        let path = [];
    ...
    test("testAddChildToGroupIdOneTextChildWrongMetadataId", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        let path = [];
    ...
    test("testSetValueGroupIdOneTextChild", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testSetValueGroupIdOneTextChildWrongMetadataId", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        dataHolder.addChild([], "textVariableId");
        assert.throws(function() {
    ...
    test("testAddTwoChildrenWithSameMetadataIdDifferentRepeatId", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        let path = [];
        dataHolder.addChild(path, "textVariableId", "one");
        dataHolder.addChild(path, "textVariableId", "two");
    ...
    test("testSetValueTwoChildrenWithSameMetadataIdDifferentRepeatId", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testAddTwoDifferentChildrenToTopLevel", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testAddTwoDifferentChildrenSetValueOnSecondToTopLevel", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testAddChildGroup", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testAddChildToSecondLevel", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testSetValueToSecondLevel", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testAddFourDifferentChildrenSomeWithAttributeToTopLevel", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testAddFourDifferentChildrenSomeWithAttributeAndChildrenToThem", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testSetValueFourDifferentChildrenSomeWithAttributeAndChildrenToThem", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        addFourDifferentChildrenSomeWithAttributeAndChildrenToThem(dataHolder);
    ...
    test("testAddEightDifferentChildrenWithRepeatIdSomeWithAttributeAndChildrenToThem", function(
        assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("setValueEightDifferentChildrenWithRepeatIdSomeWithAttributeAndChildrenToThem",
        function(assert) {
            let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testRemoveSecondLevel", function(assert) {
    ...
    test("testRemoveChildToGroupIdOneTextChildWrongMetadataId", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        let path = [];
    ...
    test("testHandleMessageRemove", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        dataHolder.addChild([], "groupIdOneTextChild");
    ...
    test("testHandleMessageRemoveEmptyPath", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testRemoveThenFindContainerDeeperChildRepeatId", function(assert) {
        let path = ["groupIdOneTextChild"];
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testRemoveTopLevelThenFindContainerDeeperChildRepeatId", function(assert) {
        let path = ["groupIdOneTextChild"];
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testAddRemoveFourDifferentChildrenWithRepeatIdSomeWithAttributeAndChildrenToThem", function(
        assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testHandleMessageRemoveThenFindContainer", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        dataHolder.addChild([], "groupIdOneTextChild");
    ...
    test("testHandleMessageMoveAfter", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testHandleMessageMoveBefore", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        dataHolder.addChild([], "groupIdOneTextChild");
        dataHolder.addChild(["groupIdOneTextChild"], "textVariableId", "1");
        dataHolder.addChild(["groupIdOneTextChild"], "textVariableId", "2");
    ...
    test("testHandleMessageMoveBeforeFirst", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        dataHolder.addChild([], "groupIdOneTextChild");
        dataHolder.addChild(["groupIdOneTextChild"], "textVariableId", "1");
        dataHolder.addChild(["groupIdOneTextChild"], "textVariableId", "2");
    ...
    test("testHandleMessageMoveWrongPath", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        dataHolder.addChild([], "groupIdOneTextChild");
        dataHolder.addChild(["groupIdOneTextChild"], "textVariableId", "1");
        dataHolder.addChild(["groupIdOneTextChild"], "textVariableId", "2");
    ...
    test("testAddChildToGroupIdOneRecordLinkChild", function(assert) {
        let dataHolder = newDataHolder("groupIdOneRecordLinkChild");
    ...
    test("testAddChildToGroupIdOneAnyTypeRecordLinkChild", function(assert) {
        let dataHolder = newDataHolder("groupIdOneAnyTypeRecordLinkChild");

        dataHolder.addChild([], "myAnyTypeLink");

        let expected = {
            name: "groupIdOneAnyTypeRecordLinkChild",
            children: [{
                name: "myAnyTypeLink",
                children: []
            }]
        ...
        dataHolder.addChild(["myAnyTypeLink"], "linkedRecordTypeTextVar");
        let expectedLinkedRecordType = {
            name: "groupIdOneAnyTypeRecordLinkChild",
            children: [{
                name: "myAnyTypeLink",
    ...
    test("testAddChildToGroupIdOneRecordLinkWithAttributeChild", function(assert) {
        let dataHolder = newDataHolder("groupIdOneRecordLinkWithAttributeChild");
    ...
    test("testHandleMsgLinkedDataActionLinksGroupIdOneRecordLinkChild", function(assert) {
        let dataHolder = newDataHolder("groupIdOneRecordLinkChild");
    ...
    test("testHandleMsgLinkedDataActionLinksGroupIdOneRecordLinkChildNoActionLink", function(assert) {
        let dataHolder = newDataHolder("groupIdOneRecordLinkChild");
        dataHolder.addChild([], "myLink");
    ...
    test("testHandleMsgLinkedDataActionLinksGroupIdOneRecordLinkChildWrongPath", function(assert) {
        let dataHolder = newDataHolder("groupIdOneRecordLinkChild");
        dataHolder.addChild([], "myLink");
    ...
    test("testAddChildToGroupIdOneResourceLinkChild", function(assert) {
        let dataHolder = newDataHolder("groupIdOneResourceLinkChild");
    ...
    test("testSetValueChildToGroupIdOneResourceLinkChild", function(assert) {
        let dataHolder = newDataHolder("groupIdOneResourceLinkChild");
        dataHolder.addChild([], "masterResLink");
        let message = {
            data: {
    ...
    test("testSetValueChildToGroupIdOneResourceLinkChild_ActionLinksStoredInternallyInDataHolder", function(assert) {
        let dataHolder = newDataHolder("groupIdOneResourceLinkChild");
        dataHolder.addChild([], "masterResLink");
        let message = {
            data: {
    ...
    test("testHandleMessageAdd", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        dataHolder.addChild([], "groupIdOneTextChild");
        dataHolder.addChild(["groupIdOneTextChild"], "textVariableId");
    ...
    test("testHandleMessageAddWrongPath", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
        dataHolder.addChild([], "groupIdOneTextChild");
        dataHolder.addChild(["groupIdOneTextChild"], "textVariableId");
    ...
    test("testHandleMessageSetValue", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testHandleMessageSetValueWrongPath", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
    ...
    test("testHandleMessageNoHandledType", function(assert) {
        let dataHolder = newDataHolder("groupIdOneTextChild");
