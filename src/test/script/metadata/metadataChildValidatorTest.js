...
QUnit.module("metadata/metadataChildValidatorTest.js", hooks => {
    ...
    test("testValidateGroupIdOneAnyTypeRecordLinkWithData", function(assert) {
        let containerChild0 = [{
        ...
        spec.childReference = createChildReference("groupIdOneAnyTypeRecordLinkChild", "0", "1", "1");
        let metadataChildValidator = CORA.metadataChildValidator(dependencies, spec);
        ...
        assertValidationResultOk(assert, validationResult, pubSub);
        assert.deepEqual(dataHolder.getRequestedPathAndMetadataId(0),
            { metadataId: "groupIdOneAnyTypeRecordLinkChild", path: [] });
        assert.deepEqual(dataHolder.getRequestedPathAndMetadataId(1),
            { metadataId: "myAnyTypeLink", path: ["groupIdOneAnyTypeRecordLinkChild"] });
        assert.deepEqual(dataHolder.getRequestedPathAndMetadataId(2),
            { metadataId: "linkedRecordTypeTextVar", path: ["groupIdOneAnyTypeRecordLinkChild", "myAnyTypeLink"] });
        assert.deepEqual(dataHolder.getRequestedPathAndMetadataId(3),
            { metadataId: "linkedRecordIdTextVar", path: ["groupIdOneAnyTypeRecordLinkChild", "myAnyTypeLink"] });
    });

    test("testValidateGroupIdOneAnyTypeRecordLinkWithDataEmptyValues", function(assert) {
        let containerChild0 = [{
            name: "groupIdOneAnyTypeRecordLinkChild",
            children: [{
                name: "myAnyTypeLink",
        ...
        let linkedRecordTypeChild = [containerChild1[0].children[0]];
        dataHolder.addToReturnForFindContainersUsingPathAndMetadataId(linkedRecordTypeChild);
        ...
        let expectedMessageType = createValidationErrorWithMetadataIdAndPath("linkedRecordTypeTextVar",
            ["groupIdOneAnyTypeRecordLinkChild", "myAnyTypeLink", "linkedRecordTypeTextVar"]
        );
        assert.stringifyEqual(messages[0], expectedMessageType);

        let expectedMessageId = createValidationErrorWithMetadataIdAndPath("linkedRecordIdTextVar",
            ["groupIdOneAnyTypeRecordLinkChild", "myAnyTypeLink", "linkedRecordIdTextVar"]
        );
        assert.stringifyEqual(messages[1], expectedMessageId);
    ...
    test("testValidateGroupIdOneAnyTypeRecordLinkWithDataEmptyIdValue", function(assert) {
        let containerChild0 = [{
            name: "groupIdOneAnyTypeRecordLinkChild",
            children: [{
                name: "myAnyTypeLink",
        ...
        assert.stringifyEqual(messages[0], expectedMessageId);
    });

    test("testValidateGroupIdOneAnyTypeRecordLinkWithDataEmptyTypeValue", function(assert) {
        let containerChild0 = [{
            name: "groupIdOneAnyTypeRecordLinkChild",
            children: [{
                name: "myAnyTypeLink",
    ...
    test("testValidateGroupId0to1RecordLinkWithDataEmptyValue", function(assert) {
        let containerChild0 = [{
            name: "groupId0to1AnyTypeRecordLinkChild",
            children: [{
                name: "myAnyTypeLink",
                children: [{
                    name: "linkedRecordType",
        ...
        spec.childReference = createChildReference("groupId0to1AnyTypeRecordLinkChild", "0", "0", "1");
        let metadataChildValidator = CORA.metadataChildValidator(dependencies, spec);
        ...
        let expectedMessageType = createValidationErrorWithMetadataIdAndPath("linkedRecordTypeTextVar",
            ["groupId0to1AnyTypeRecordLinkChild", "myAnyTypeLink", "linkedRecordTypeTextVar"]
        );
        assert.stringifyEqual(messages[0], expectedMessageType);

        let expectedMessageId = createValidationErrorWithMetadataIdAndPath("linkedRecordIdTextVar",
            ["groupId0to1AnyTypeRecordLinkChild", "myAnyTypeLink", "linkedRecordIdTextVar"]
        );
        assert.stringifyEqual(messages[1], expectedMessageId);

        let expectedMessage2 = createRemoveMessageWithPath(["groupId0to1AnyTypeRecordLinkChild", "myAnyTypeLink"]);
        assert.stringifyEqual(messages[2], expectedMessage2);

        let expectedMessage3 = createRemoveMessageWithPath(["groupId0to1AnyTypeRecordLinkChild"]);
        assert.stringifyEqual(messages[3], expectedMessage3);
        assert.deepEqual(dataHolder.getRequestedPathAndMetadataId(0),
            { metadataId: "groupId0to1AnyTypeRecordLinkChild", path: [] });
        assert.deepEqual(dataHolder.getRequestedPathAndMetadataId(1),
            { metadataId: "myAnyTypeLink", path: ["groupId0to1AnyTypeRecordLinkChild"] });
        assert.deepEqual(dataHolder.getRequestedPathAndMetadataId(2),
            { metadataId: "linkedRecordTypeTextVar", path: ["groupId0to1AnyTypeRecordLinkChild", "myAnyTypeLink"] });
        assert.deepEqual(dataHolder.getRequestedPathAndMetadataId(3),
            { metadataId: "linkedRecordIdTextVar", path: ["groupId0to1AnyTypeRecordLinkChild", "myAnyTypeLink"] });
    });


    test("testValidateGroupId0to1AnyTypeRecordLinkWithDataEmptyIdValue", function(assert) {
        let containerChild0 = [{
            name: "groupId0to1AnyTypeRecordLinkChild",
            children: [{
                name: "myAnyTypeLink",
        ...
        spec.childReference = createChildReference("groupId0to1AnyTypeRecordLinkChild", "0", "1", "1");
        let metadataChildValidator = CORA.metadataChildValidator(dependencies, spec);
    ...
    test("testValidateGroupId0to1AnyTypeRecordLinkWithDataEmptyTypeValue", function(assert) {
        let containerChild0 = [{
            name: "groupId0to1AnyTypeRecordLinkChild",
            children: [{
                name: "myAnyTypeLink",
