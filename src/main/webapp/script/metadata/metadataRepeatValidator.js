 ...
 * Copyright 2020, 2024, 2026 Uppsala University Library
 *
    ...
    cora.metadataRepeatValidator = function(metadataId, path, dataHolder, data, repeatId, metadataProvider,
        ...
        const validateForMetadata = function() {
            if (isGroup()) {
                ...
                validateMetadataAnyTypeRecordLink(path);
        ...
        const validateMetadataAnyTypeRecordLink = function(nextLevelPath) {
            validateLinkedRecordType(nextLevelPath);
            validateLinkedRecordId(nextLevelPath);
            possiblyValidateLinkedRepeatId(nextLevelPath);
        };
        const validateLinkedRecordType = function(nextLevelPath) {
