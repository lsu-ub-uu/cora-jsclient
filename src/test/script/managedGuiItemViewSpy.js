...
var CORATEST = (function(coraTest) {
	...
	coraTest.managedGuiItemViewSpy = function(dependencies, spec) {
		...
		let removedChildren = [];
		let movedChildren = [];
		let menuView = CORA.createSpanWithClassName("managedGuiItemMenuViewSpyView");
		let workView = CORA.createSpanWithClassName("managedGuiItemWorkViewSpyView");
		let listView = CORA.createSpanWithClassName("managedGuiItemListViewSpyView");
