...
QUnit.module("metadata/metadataRepeatInitializerTest.js", hooks => {
    ...
    test("testAnyTypeRecordLinkMessage", function(assert) {
        spec.metadataId = "myAnyTypeLink";
        ...
        let expectedAddForRecordLink = {
            type: "add",
            message: {
                metadataId: "myAnyTypeLink",
                path: [],
                nameInData: "myAnyTypeLink"
            }
        };
        assert.stringifyEqual(messages[0], expectedAddForRecordLink);
    ...
    test("testAnyTypeRecordLinkCorrectCallToChildAndRepeatInitalizerNoDataNoRepeatId", function(assert) {
        spec.data = {
            name: "myAnyTypeLink",
            children: [{ name: "linkedRecordType", value: "anyData" }]
        };
        spec.metadataId = "myAnyTypeLink";
        ...
        assert.stringifyEqual(linkedRecordTypeSpec.childReference, expectedRecordTypeReference);
        assert.stringifyEqual(linkedRecordTypeSpec.data, spec.data);
        assert.stringifyEqual(linkedRecordTypeSpec.path, ["myAnyTypeLink"]);
        ...
        assert.stringifyEqual(linkedRecordIdSpec.childReference, expectedRecordIdReference);
        assert.stringifyEqual(linkedRecordIdSpec.data, spec.data);
        assert.stringifyEqual(linkedRecordIdSpec.path, ["myAnyTypeLink"]);
    });

    test("testAnyTypeRecordLinkWithMessagesNonEmptyPathInSpec", function(assert) {
        spec.path = ["recordInfo", "type"];
        spec.metadataId = "myAnyTypeLink";
